                                ...
                                Email_Token.get(tokenInsertId, function (err, tokens) {
                                    ...
                                    User.get(user_id, function (err, users) {
                                        ...
                                        Email_Helper.sendVerificationEmail(userEmail, fromAddress, subject, text, html, function (err, response) {
                                            ...
                                            // done callback (strategy callback) arguments are error, user, info
                                            // option 1 - return done(null, user) and handle the requirements in a custom callback
                                            // option 2 - return done(null, user) and redirect to home page directly. User will be logged in by default
                                        });
                                    });
                                });
                            });
